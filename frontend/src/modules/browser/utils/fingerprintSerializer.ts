...
export const PRESET_RESOLUTIONS = ['1920,1080', '1440,900', '1512,982', '1728,1117', '1366,768', '2560,1440', '1600,900']
...
export const FINGERPRINT_PRESETS: FingerprintPreset[] = [
  ...
  },
  {
    ...
    description: '模拟美国普通用户，英文环境，Intel 核显',
    config: {
      brand: 'Chrome',
      platform: 'windows',
      lang: 'en-US',
